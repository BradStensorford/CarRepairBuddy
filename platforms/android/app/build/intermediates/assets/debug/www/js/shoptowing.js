...
var shopServiceOptions = {
    ...
    item: '<li class="media list-group-item"><div class="media-body"><h4 class="media-heading"><strong class="iname"></strong></h4><p class="idesc"></p><hr style="margin: 5px 0;"><button class="btn btn-primary btn-sm pull-right selectId" onclick="modalShowData(this)">More Information</button></div></li>',
    page: 5,
    pagination: true
};
