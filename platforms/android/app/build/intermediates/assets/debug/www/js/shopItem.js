...
var shopItemOptions = {
    valueNames: ['iname', 'icode', 'iavail', 'icat', 'idesc', { attr: 'src', name: 'iimg' }, { attr: 'data-id', name: 'selectId' }],
    item: '<li class="media list-group-item item dta"><div class="media-left media-top"><img class="iimg img-circle" width="75px" height="75px"></div><div class="media-body"><h4 class="media-heading"><strong class="iname"></strong></h4><hr style="margin:0;"><span class="label label-primary">Category: <i class="icat"></i></span><br><span class="label label-success">Availability: <i class="iavail"></i></span><br><span class="label label-info">Item Code:  <i class="icode"></i></span><hr style="margin-top: 5px;"><p style="text-align:justify;" class="idesc"></p><button class="selectId btn btn-primary btn-sm pull-right" onclick="modalShowData(this)">More Information</button></div></li>',
    page: 5,
    pagination: true
};
